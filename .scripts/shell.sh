...
git clone git@github.com:Jmclerck/zsh-ci-status.git ~/.zsh/zsh-ci-status
...
git clone git@github.com:Jmclerck/zsh-pg-status.git ~/.zsh/zsh-pg-status
...
git clone git@github.com:zdharma/fast-syntax-highlighting ~/.zsh/fast-syntax-highlighting
